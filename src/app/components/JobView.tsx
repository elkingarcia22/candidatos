          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              {vacancy?.status === 'draft' ? (
                ...
                <>
                  <div className="p-[2px] bg-[linear-gradient(to_right,#0C5BEF,#8823EA,#EA066F,#FF5416)] rounded-full group transition-all hover:shadow-lg hover:shadow-indigo-100">
                    <Button
                      onClick={() => {
              ...
              <div className="p-8 border-2 border-dashed border-gray-200 rounded-[32px] max-w-md text-center bg-white shadow-sm">
                ...
                <div className="flex flex-col items-center gap-8">
                  <div className="flex items-center gap-4">
                    <div className="p-[2px] bg-[linear-gradient(to_right,#0C5BEF,#8823EA,#EA066F,#FF5416)] rounded-[20px] group transition-all hover:shadow-xl hover:shadow-indigo-100">
                      <Button 
                        variant="ghost"
                        onClick={() => {
                          setIsSerenaOpen(true);
