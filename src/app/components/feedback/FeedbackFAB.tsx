  ...
  return (
    <div className={`fixed bottom-8 ${positionClasses} z-[9999] flex flex-col items-end gap-3 transition-all duration-500`}>
      ...
      <motion.button
        ...
        className={`relative h-14 ${isExpanded ? 'px-6' : 'w-14'} rounded-2xl bg-[linear-gradient(135deg,#0C5BEF,#8823EA,#EA066F,#FF5416)] text-white flex items-center justify-center shadow-[0_20px_40px_-10px_rgba(79,70,229,0.5)] overflow-hidden`}
